...
text = re.sub(r'<button((?![^>]*\btype=)[^>]*)>', r'<button type="button"\1>', text)
text = re.sub(r'(<input[^>]*\bname="name"[^>]*)(?<!\btype="[^"]*")>', r'<input type="text"\1>', text)
text = re.sub(r'(<input[^>]*\bname="company"[^>]*)(?<!\btype="[^"]*")>', r'<input type="text"\1>', text)
